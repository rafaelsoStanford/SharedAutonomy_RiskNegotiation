...
class LoadCarRacingData(pl.LightningDataModule):
    ...
    def __getitem__(self, idx):
        ...
        nsample['action_obs'] = nsample['actions_pred'][:self.T_obs,:]
        nsample['velocity_obs'] = nsample['velocities_pred'][:self.T_obs,:]
        nsample['position_obs'] = nsample['positions_pred'][:self.T_obs,:]
        return nsample
